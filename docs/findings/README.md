...
| ID | Severity | Status | Finding | Primary files |
|---|---|---|---|---|
...
| [W3](w3-checkpoint-monotonicity-and-ownership.md) | High | **Fixed** — CAS, [ADR 0036](../adr/0036-checkpoint-advances-are-compare-and-set.md) | Checkpoints accept backwards writes and have no owner | `postgres.checkpoint.ts` |
