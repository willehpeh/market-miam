...
import { catalogueFeature } from '../catalogue/state/catalogue.state';
...
import { marketDayFeature } from '../market-days/store/market-day.state';
import { MarketDayEffects } from '../market-days/store/market-day.effects';
