...
@Module({
  ...
  InMemoryMarketScheduleViews,
    ...
    InMemoryMarketDayViews,
    { provide: MarketDayViews, useExisting: InMemoryMarketDayViews },
    { provide: MarketDayViewStore, useExisting: InMemoryMarketDayViews },
    InMemoryMarketPricesViews,
    { provide: MarketPricesViews, useExisting: InMemoryMarketPricesViews },
    { provide: MarketPricesViewStore, useExisting: InMemoryMarketPricesViews },
    InMemorySubdomainRegistry,
