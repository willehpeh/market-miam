...
const views = [
  ...
  {
    provide: PostgresMarketPricesViews,
    useFactory: (uow: PostgresUnitOfWork) => new PostgresMarketPricesViews(uow),
    inject: [PostgresUnitOfWork],
  },
  { provide: MarketPricesViews, useExisting: PostgresMarketPricesViews },
  { provide: MarketPricesViewStore, useExisting: PostgresMarketPricesViews },
  {
