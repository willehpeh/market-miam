...
describe('Request shape', () => {
  ...
  const cases: [description: string, method: 'post' | 'put', url: string, body: unknown, field: string][] = [
    ...
    ['a menu whose itemIds is not an array', 'put', '/market-days/market-1/2026-06-30/menu', { itemIds: 'dish-1' }, 'itemIds'],
    ['a menu holding a non-string id', 'put', '/market-days/market-1/2026-06-30/menu', { itemIds: [7] }, 'itemIds.0'],
    ['a dish without a name', 'post', '/catalogue', { itemId: 'dish-1', description: 'Mijoté' }, 'name'],
    ['a dish whose variants is not an array', 'post', '/catalogue', { itemId: 'dish-1', name: 'Bœuf', description: '', variants: 'grande' }, 'variants'],
    ['a variant without a price', 'post', '/catalogue', { itemId: 'dish-1', name: 'Bœuf', description: '', variants: [{ name: 'Grande', description: '' }] }, 'variants.0.price'],
    ['a reorder without itemIds', 'put', '/catalogue/order', {}, 'itemIds'],
    ['a revision without a description', 'put', '/catalogue/dish-1', { name: 'Bœuf' }, 'description'],
    ['a photo without its reference', 'put', '/catalogue/dish-1/photo', {}, 'imageReference'],
    ['a photo signature without its dish', 'post', '/catalogue/photo/signature', {}, 'itemId'],
