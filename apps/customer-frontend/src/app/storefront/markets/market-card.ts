    ...
    >
      ...
      <span class="min-w-0 flex-1 pt-1">
        ...
        @if (market().dishes.length) {
          <span data-menu class="mt-3 block border-t border-line pt-3">
            @for (dish of market().dishes; track dish.name) {
              <span class="flex justify-between gap-3 py-0.5 text-sm">
